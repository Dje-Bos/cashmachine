...
public class ReceiptTestData {
    public static final ReceiptModel RECEIPT_0 = new ReceiptModel(1L, convert("2019-05-17T18:57:52"), UserTestData.SAVED_USER, Set.of(ReceiptEntriesData.ENTRY_0, ReceiptEntriesData.ENTRY_1), BigDecimal.valueOf(2501.0), "OK");
    public static final ReceiptModel RECEIPT_1 = new ReceiptModel(2L, convert("2019-05-17T18:58:52"), UserTestData.SAVED_USER, Set.of(ReceiptEntriesData.ENTRY_2), BigDecimal.valueOf(458.3), "OK");
